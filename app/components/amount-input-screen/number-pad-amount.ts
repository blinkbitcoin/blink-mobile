...
import { NumberPadNumber, NumberPadReducerState } from "./number-pad-reducer"

export const numberPadNumberToMoneyAmount = ({
  numberPadNumber,
  currency,
  currencyInfo,
}: {
...
export const moneyAmountToNumberPadReducerState = ({
  moneyAmount,
  currencyInfo,
}: {
