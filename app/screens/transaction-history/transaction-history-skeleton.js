...
var TransactionHistorySkeleton = function () {
    var styles = useStyles();
    var height = useWindowDimensions().height;
    return (<View style={styles.container}>
      <ContentLoader height={height} width="100%" speed={1.2} backgroundColor={styles.background.color} foregroundColor={styles.foreground.color}>
...
//# sourceMappingURL=transaction-history-skeleton.js.map