...
import { PhoneCodeChannelType, useUserLoginMutation, useUserLoginUpgradeMutation, } from "@app/graphql/generated";
import { AccountLevel, useLevel } from "@app/graphql/level-context";
import { useI18nContext } from "@app/i18n/i18n-react";
import { logUpgradeLoginAttempt, logUpgradeLoginSuccess, logValidateAuthCodeFailure, } from "@app/utils/analytics";
...
var mapValidatePhoneCodeErrorsToMessage = function (error, LL) {
    switch (error.type) {
        ...
        default:
            return LL.errors.generic() + (error.msg ? " Error Message: ".concat(error.msg) : "");
    }
};
export var PhoneLoginValidationScreen = function (_a) {
    var route = _a.route;
    ...
    var userLoginMutation = useUserLoginMutation({
        fetchPolicy: "no-cache",
    })[0];
    var userLoginUpgradeMutation = useUserLoginUpgradeMutation({
        fetchPolicy: "no-cache",
    })[0];
    var currentLevel = useLevel().currentLevel;
    var isUpgradeFlow = currentLevel === AccountLevel.Zero;
    ...
    var _f = route.params, phone = _f.phone, channel = _f.channel, onboarding = _f.onboarding;
    var colors = useTheme().theme.colors;
    var send = useCallback(function (code) { return __awaiter(void 0, void 0, void 0, function () {
        var errors, data, success, authToken, data, authToken, totpRequired, error_1, err_1;
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, userLoginUpgradeMutation({
                            variables: { input: { phone: phone, code: code } },
                        })];
                case 2:
                    data = (_g.sent()).data;
                    success = (_a = data === null || data === void 0 ? void 0 : data.userLoginUpgrade) === null || _a === void 0 ? void 0 : _a.success;
                    authToken = (_b = data === null || data === void 0 ? void 0 : data.userLoginUpgrade) === null || _b === void 0 ? void 0 : _b.authToken;
                    if (success) {
                    ...
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, userLoginMutation({
                        variables: { input: { phone: phone, code: code } },
                    })];
                case 4:
                    data = (_g.sent()).data;
                    authToken = (_d = data === null || data === void 0 ? void 0 : data.userLogin) === null || _d === void 0 ? void 0 : _d.authToken;
                    totpRequired = (_e = data === null || data === void 0 ? void 0 : data.userLogin) === null || _e === void 0 ? void 0 : _e.totpRequired;
                    if (authToken) {
                        if (totpRequired) {
    ...
    switch (status) {
        case ValidatePhoneCodeStatus.ReadyToRegenerate:
          ...
          {(error === null || error === void 0 ? void 0 : error.type) ===
                    ValidatePhoneCodeErrors.CannotUpgradeToExistingAccount ? null : (<View style={styles.marginBottom}>
              <GaloyInfo>
    ...
    return (<Screen preset="scroll" style={styles.screenStyle} keyboardOffset="navigationHeader" keyboardShouldPersistTaps="handled">
      <View style={styles.viewWrapper}>
        ...
        <Input placeholder="000000" containerStyle={styles.inputComponentContainerStyle} inputContainerStyle={styles.inputContainerStyle} inputStyle={styles.inputStyle} value={code} onChangeText={setCode} renderErrorMessage={false} autoFocus={true} textContentType={"oneTimeCode"} keyboardType="numeric" {...testProps("oneTimeCode")}/>
