...
export var EmailLoginValidateScreen = function (_a) {
    var route = _a.route;
    ...
    var _d = route.params, emailLoginId = _d.emailLoginId, email = _d.email;
    var send = useCallback(function (code) { return __awaiter(void 0, void 0, void 0, function () {
        var url, res2, authToken, totpRequired, err_1;
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    setLoading(true);
                    url = "".concat(authUrl, "/auth/email/login");
    ...
    var header = LL.EmailLoginValidateScreen.header({ email: email });
