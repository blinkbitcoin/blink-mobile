...
export var AccountScreen = function () {
    ...
    return (<AccountDeleteContextProvider>
      <Screen keyboardShouldPersistTaps="handled">
        <ScrollView contentContainerStyle={styles.outer} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh}/>} {...testProps("account-screen-scroll-view")}>
          <AccountBannerVertical />
          <UpgradeTrialAccount />
          <SettingsGroup items={[UpgradeAccountLevelOne]} name={LL.AccountScreen.upgrade()}/>
          <AccountId />
          <DangerZoneSettings />
        </ScrollView>
      </Screen>
