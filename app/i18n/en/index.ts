...
const en: BaseTranslation = {
  ...
  NostrWalletConnect: {
    ...
    connectedAppsEmptyTitle: "No connected apps",
    connectedAppsEmptyBody:
      "Apps you connect with Nostr Wallet Connect will appear here.",
    connectedAppsLoadError: "Unable to load connected apps. Pull to refresh.",
    connectionDetails: "Connection details",
    connectionDetailsUnavailable: "Connection details are unavailable.",
    lastUsed: "Last used: {date: string}",
    ...
    revokeFailed: "Unable to revoke this connection. Try again.",
    revokeConfirmTitle: "Revoke connection?",
    revokeConfirmBody:
      "{appName: string} will immediately lose access to your wallet.",
    revokeAllConnections: "Revoke all connections",
    revokeAllFailed: "Unable to revoke connections. Try again.",
    revokeAllSuccess: "{count: number} connection(s) revoked",
    revokeAllConfirmTitle: "Revoke all connections?",
    revokeAllConfirmBody:
      "Every connected app will immediately lose access to your wallet. This cannot be undone.",
    revokeAllTypeConfirm: 'Type "{confirmation: string}" to confirm.',
