...
const en: BaseTranslation = {
  ...
  CardDetailsScreen: {
    ...
    features:{
      ...
      startup: "Bitcoin startup deal flow",
  ...
  CardCreditLimit: {
    welcomeMessage: {
      ...
      paragraphs: {
        body1: "Before we raise more funds from professional investors we decided to extend an invitation to the Blink extended family, our superusers and supporters. Why bring onboard strangers when we can first invite someone like you?",
  ...
  TopUpScreen: {
    title: "Top-up",
    qrTitle: "Insuffient funds in your Blink wallet.\nTop-up minimum of {minAmount: string}.",
    copy: "Copy",
    share: "Share",
