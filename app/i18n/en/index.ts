...
const en: BaseTranslation = {
  ...
  NostrWalletConnect: {
    ...
    budgetLimitsSet: "{count: number} budget limit(s) set",
    permissions: "Permissions",
    permissionReceiveOnly: "Receive-only",
    permissionReadHistory: "Read history",
    permissionMakePayments: "Make payments",
    ...
    dismiss: "Dismiss",
    authorizationAppTitle: "Connect {appName: string}",
    appIdentifier: "App identifier",
    willBeAbleTo: "Will be able to",
    willNotBeAbleTo: "Will NOT be able to",
    permissionGetInfo: "Request wallet info",
    permissionGetBalance: "View your balance",
    permissionMakeInvoice: "Create invoices",
    permissionPayInvoice: "Pay invoices from your wallet",
    permissionLookupInvoice: "Look up invoices",
    permissionListTransactions: "View transactions",
    permissionNotificationsPaymentSent: "Receive payment sent notifications",
    permissionNotificationsPaymentReceived: "Receive payment received notifications",
    permissionNoKeys: "Access your recovery phrase or private keys",
    permissionNoSecurityChanges: "Change your Blink security settings",
    permissionNoOverBudget: "Spend above the budget you set",
    budgetAmount: "Budget amount",
    budgetPeriod: "Budget period",
    budgetPreview: "{amount: string} per {period: string}",
    budgetExceedsBalanceWarning:
    ...
    periodNever: "Never",
    authorize: "Authorize",
    invalidConnectionRequest: "Invalid connection request",
    invalidNwcUri: "This Nostr Wallet Connect link is malformed.",
    invalidNwcPubkey: "This connection request has an invalid wallet pubkey.",
    missingNwcRelay: "This connection request is missing a relay.",
    invalidNwcRelay: "This connection request has an invalid relay.",
    missingNwcSecret: "This connection request is missing a secret.",
    unsupportedNwcPermissions:
      "This connection request includes permissions Blink does not support yet.",
    connectionAlreadyExists: "This app is already connected.",
    connectionRelayUnreachable: "Cannot reach connection server. Check internet.",
    connectionNetworkError: "Unable to connect right now. Check your connection and try again.",
    connectionCreateFailed: "Unable to create this connection. Try again.",
    retry: "Retry",
    replaceConnection: "Replace connection",
    authorizationSuccessTitle: "{appName: string} is connected",
    authorizationSuccessBody:
      "{appName: string} can now use the permissions you approved.",
    authorizationSummary: "Authorized summary",
    satsbackReady: "You're ready to earn rewards!",
  },
}
