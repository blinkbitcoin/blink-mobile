...
import { CurrencyListDocument, DisplayCurrencyDocument, HomeAuthedDocument, HomeUnauthedDocument, LnNoAmountInvoiceCreateDocument, MobileUpdateDocument, MyLnUpdatesDocument, OnChainAddressCurrentDocument, PaymentRequestDocument, RealtimePriceDocument, SendBitcoinConfirmationScreenDocument, SendBitcoinDestinationDocument, SendBitcoinDetailsScreenDocument, UserUpdateUsernameDocument, MyUserIdDocument, TransactionListForDefaultAccountDocument, UserLoginUpgradeTelegramDocument, } from "./generated";
...
export default __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], mocks, true), mocks, true), mocks, true), mocks, true), mocks, true), mocks, true);
