        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            if ! avdmanager list avd -c | grep -q Pixel_API_35; then
              ...
              echo no | avdmanager create avd --force -n Pixel_API_35 --abi "google_apis_playstore/$ARCH" --package "system-images;android-35;google_apis_playstore;$ARCH" --device 'pixel_6a'
            fi
