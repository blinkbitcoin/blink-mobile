...
jest.mock("@app/components/upgrade-account-modal", function () { return ({
    TrialAccountLimitsModal: function () { return jest.fn(); },
}); });
jest.mock("react-native-nfc-manager", function () {
    return {
        NfcManager: {
            start: jest.fn(),
            stop: jest.fn(),
