...
import { createIntraLedgerDestination, resolveIntraledgerDestination, } from "@app/screens/send-bitcoin-screen/payment-destination";
...
describe("resolve intraledger", function () {
    var defaultIntraledgerParams = {
    ...
    it("returns invalid destination if wallet is not found", function () { return __awaiter(void 0, void 0, void 0, function () {
        var destination;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    defaultIntraledgerParams.accountDefaultWalletQuery.mockResolvedValue({ data: {} });
                    return [4 /*yield*/, resolveIntraledgerDestination(defaultIntraledgerParams)];
                case 1:
                    destination = _a.sent();
    ...
    it("returns invalid destination if user is owned by self", function () { return __awaiter(void 0, void 0, void 0, function () {
        var destination;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it("returns a valid destination if username exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        var destination;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    expect(destination).toEqual(expect.objectContaining({
                        valid: true,
                        validDestination: __assign(__assign({}, defaultIntraledgerParams.parsedIntraledgerDestination), { walletId: "successwalletid", valid: true }),
                    }));
                    return [2 /*return*/];
            }
        });
...
describe("create intraledger destination", function () {
    var createIntraLedgerDestinationParams = {
        parsedIntraledgerDestination: {
            paymentType: "intraledger",
            handle: "testhandle",
            valid: true,
    ...
    it("correctly creates payment detail", function () {
        var intraLedgerDestination = createIntraLedgerDestination(createIntraLedgerDestinationParams);
