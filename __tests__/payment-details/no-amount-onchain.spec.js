...
describe("no amount lightning payment details", function () {
    var createNoAmountOnchainPaymentDetails = PaymentDetails.createNoAmountOnchainPaymentDetails;
    it("properly sets fields with all arguments provided", function () {
        var paymentDetails = createNoAmountOnchainPaymentDetails(defaultParams);
    ...
    describe("sending from a btc wallet", function () {
        ...
        var paymentDetails = createNoAmountOnchainPaymentDetails(btcSendingWalletParams);
    ...
    describe("sending from a usd wallet", function () {
        ...
        var paymentDetails = createNoAmountOnchainPaymentDetails(usdSendingWalletParams);
    ...
    it("cannot calculate fee or send payment with zero amount", function () {
        ...
        var paymentDetails = createNoAmountOnchainPaymentDetails(params);
    ...
    it("cannot set memo if memo is provided", function () {
        ...
        var paymentDetails = createNoAmountOnchainPaymentDetails(paramsWithMemo);
