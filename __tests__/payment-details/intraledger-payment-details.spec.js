...
import { btcSendingWalletDescriptor, convertMoneyAmountMock, createSendPaymentMocks, expectCannotGetFee, expectCannotSendPayment, expectDestinationSpecifiedMemoCannotSetMemo, testAmount, usdSendingWalletDescriptor, zeroAmount, } from "./helpers";
var defaultParams = {
    handle: "test",
...
describe("intraledger payment details", function () {
    ...
    it("properly sets fields with all arguments provided", function () {
        var paymentDetails = createIntraledgerPaymentDetails(defaultParams);
    ...
    describe("sending from a btc wallet", function () {
        ...
        var paymentDetails = createIntraledgerPaymentDetails(btcSendingWalletParams);
    ...
    describe("sending from a usd wallet", function () {
        ...
        var paymentDetails = createIntraledgerPaymentDetails(usdSendingWalletParams);
        it("uses the correct send payment mutation and args", function () { return __awaiter(void 0, void 0, void 0, function () {
            var sendPaymentMocks, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    it("cannot calculate fee or send payment with zero amount", function () {
        var paramsWithMemo = __assign(__assign({}, defaultParams), { unitOfAccountAmount: zeroAmount });
        var paymentDetails = createIntraledgerPaymentDetails(paramsWithMemo);
