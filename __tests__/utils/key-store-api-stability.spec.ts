...
const PINNED_SURFACE = [
  ...
  "clearUninstallSurvivingKeyMaterial",
  ...
  "readIsPinEnabled",
  "readMnemonicAccounts",
  "readMnemonicNetworkWithStatus",
  "readMnemonicWithStatus",
  "readSessionProfiles",
  "rebuildMnemonicAccountsIfMalformed",
  ...
  "setPinFailureState",
  "slotFor",
  "trackMnemonicAccount",
  "untrackMnemonicAccount",
]
