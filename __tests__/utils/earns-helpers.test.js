import { errorCodeAlertAlreadyShown, getQuizQuestionsContent, markErrorCodeAlertAsShown, skipRewardErrorCodes, } from "@app/screens/earns-screen/helpers";
import { i18nObject } from "../../app/i18n/i18n-util";
import { loadLocale } from "../../app/i18n/i18n-util.sync";
var expectedEnglishQuizSections = [
    {
        section: {
            id: "bitcoinWhatIsIt",
    ...
    },
    {
        ...
        content: [
            ...
            },
            {
                ...
                question: "How does the Bitcoin network ensure that new blocks are added roughly every 10 minutes?",
                answers: [
...
describe("Earn utils test", function () {
    it("Converts quiz sections to proper types", function () {
        loadLocale("en");
        var LL = i18nObject("en");
        var quizSectionContent = getQuizQuestionsContent({ LL: LL });
        expect(quizSectionContent).toStrictEqual(expectedEnglishQuizSections);
    });
    describe("skipRewardErrorCodes", function () {
        it("returns true for codes in skipRewardErrorCodesList", function () {
        ...
        it("returns false for unknown or null codes", function () {
    ...
    describe("errorCodeAlertAlreadyShown & markErrorCodeAlertAsShown", function () {
        it("returns false if code has not been marked yet", function () {
            expect(errorCodeAlertAlreadyShown("NOT_ENOUGH_BALANCE_FOR_QUIZ")).toBe(false);
        });
        it("returns true after marking the code", function () {
        ...
        it("ignores null or undefined codes", function () {
...
//# sourceMappingURL=earns-helpers.test.js.map